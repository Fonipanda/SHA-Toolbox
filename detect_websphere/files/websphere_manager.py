...
class WebsphereManager:
    ...
    def __init__(self):
        ...
        self.product_mapping = {
            "Liberty": ["/apps/WebSphere"],
            "Was_8": ["/apps/WebSphere85", "/apps/WebSphere855"],
            "Was_9": ["/apps/WebSphere95", "/apps/WebSphere9"]
        }

    def check_product(self) -> list[str]:
        """
        Check for WebSphere installations in the /apps directory.
        ...
        try:
            result = subprocess.run(
                ['find', '/apps', '-type', 'd', '-name', 'WebSphere*'],
    ...
    def list_matching_paths(self, pattern: str) -> list[str]:
        """
